...
module MenuUtils {
    ...
    class Menu extends UI.View {
        ...
        var activeMenuYStart = 0;
        var activeMenuYEnd = 0;
            ...
            while (y < h && i < s) {
                ...
                if (i == -1) {
                    ...
                    if (value == null) {
                        ...
                        dc.drawText(w/2, y+padding+largeHeight+2, smallFont, value, G.TEXT_JUSTIFY_CENTER);
                    }
        ...
        function onMenuTap(y) {
            if (y < activeMenuYStart) {
                onMenuMove(1);
            } else if (y < activeMenuYEnd) {
                onMenuSelect();
            } else {
                onMenuMove(-1);
            }
